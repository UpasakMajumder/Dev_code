        ...
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvPosNo" runat="server" Display="Dynamic" InitialValue="0" ForeColor="Red" ControlToValidate="ddlPosNo">
        ...
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvBrand" runat="server" Display="Dynamic" InitialValue="0" ForeColor="Red" ControlToValidate="ddlBrand">
                    </asp:RequiredFieldValidator>
                </div>
            </div>
        </div>
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvShortDes" runat="server" Display="Dynamic" ForeColor="Red" ControlToValidate="txtShortDes">
                    </asp:RequiredFieldValidator>
                </div>
            </div>
        </div>
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvLongDes" Display="Dynamic" runat="server" ForeColor="Red" ControlToValidate="txtLongDes">
                    </asp:RequiredFieldValidator>
                </div>
            </div>
        </div>
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvBundleQnt" Display="Dynamic" runat="server" ForeColor="Red" ControlToValidate="txtBundleQnt">
                    </asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="revBundleQnt" Display="Dynamic" runat="server"
        ...
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner date_picker">
                    <cms:CMSTextBox ID="txtExpDate" runat="server" CssClass="input__text" EnableViewState="false" Display="Dynamic" TextMode="DateTime"></cms:CMSTextBox>
                    <asp:RequiredFieldValidator ID="rfvExpDate" runat="server" Display="Dynamic" ForeColor="Red" ControlToValidate="txtExpDate">
                    </asp:RequiredFieldValidator>
                </div>
            </div>
        </div>
        ...
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvEstPrice" runat="server" Display="Dynamic" ForeColor="Red" ControlToValidate="txtEstPrice"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="revEstPrice" runat="server" Display="Dynamic"
        ...
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvActualPrice" runat="server" Display="Dynamic" ForeColor="Red" ControlToValidate="txtActualPrice"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="revActualPrice" runat="server"
                        ControlToValidate="txtActualPrice" Display="Dynamic" ValidationExpression="((\d+)((\.\d{1,100})?))$" ForeColor="Red">
                    </asp:RegularExpressionValidator>
                </div>
            </div>
        </div>
            ...
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RegularExpressionValidator ID="revQuantity" runat="server"
                        ControlToValidate="txtQuantity" ValidationExpression="^[0-9]*$" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                </div>
            </div>
        </div>
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvState" runat="server" Display="Dynamic" InitialValue="0" ForeColor="Red" ControlToValidate="ddlState"></asp:RequiredFieldValidator>
                </div>
            </div>
        </div>
        ...
        <div class="mb-2 form__block">
            <div class="input__wrapper">
                ...
                <div class="input__inner">
                    ...
                    <asp:RequiredFieldValidator ID="rfvProdCategory" runat="server" Display="Dynamic" InitialValue="0" ForeColor="Red" ControlToValidate="ddlProdCategory"></asp:RequiredFieldValidator>
                </div>
            </div>
        </div>
        <div class="mb-2 form__block">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RegularExpressionValidator ID="revAllQuantity" runat="server" Display="Dynamic"
