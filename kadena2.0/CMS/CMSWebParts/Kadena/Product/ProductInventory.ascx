            ...
            <ItemTemplate>
                <div class="cus__content--block col-sm-3">
                    ...
                    <div class="custom__blockin">
                        <h4><cms:LocalizedLabel runat="server" ID="lblPosNumber" CssClass="input__label" ResourceString="KDA.ProductInventory.POSNoText"></cms:LocalizedLabel> <%# Eval("SKUProductCustomerReferenceNumber")%></h4>
                        <h3><%#Eval("SKUName") %></h3>
