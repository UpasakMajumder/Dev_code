        ...
        <ItemTemplate>
            <div class="cus__content--block col-sm-3" id="imagediv">
                ...
                <div class="input__wrapper custom__blockin">
                    <h4><cms:LocalizedLabel runat="server" ID="lblPosNumber" CssClass="input__label" ResourceString="KDA.CustomCatalog.PosNumberLabel"></cms:LocalizedLabel> <%# Eval("SKUProductCustomerReferenceNumber")%></h4>
