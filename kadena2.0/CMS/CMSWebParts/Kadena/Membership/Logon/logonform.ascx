<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Kadena_Membership_Logon_logonform" CodeBehind="~/CMSWebParts/Kadena/Membership/Logon/logonform.ascx.cs" %>
