<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="~/CMSModules/Kadena/Pages/Products/CampaignProductsImport.aspx.cs" Inherits="Kadena.CMSModules.Kadena.Pages.Products.CampaignProductsImport"
...
<asp:Content ID="cntBody" ContentPlaceHolderID="plcContent" runat="Server">
    <div class="form-horizontal">
        ...
        <!-- Product block -->
        <h4 class="anchor">Campaign Products</h4>
        <h4>Download template sheet for Campaign Products</h4>
        <div class="form-group" style="margin-bottom: 3rem">
