...
public partial class CMSModules_Membership_FormControls_Passwords_KadenaPasswordStrength : FormEngineUserControl
{
    #region "Variables"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            rfvPassword.ErrorMessage = ResHelper.GetString("Kadena.ChangePassword.NewPwdRequired");
