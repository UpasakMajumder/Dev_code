...
public partial class CMSModules_Forums_Controls_NewPost : ForumViewer
{
    ...
    private ForumActivityLogger mForumActivityLogger = new ForumActivityLogger();
    ...
    /// Logs "post" activity.
    /// </summary>
    /// <param name="forumPostInfo">Forum post object</param>
    /// <param name="forumInfo">Forum info</param>
    private void LogPostActivity(ForumPostInfo forumPostInfo, ForumInfo forumInfo)
    {
        if ((forumPostInfo == null) || (forumInfo == null) || !forumInfo.ForumLogActivity || (DocumentContext.CurrentDocument == null))
        {
            return;
        }
