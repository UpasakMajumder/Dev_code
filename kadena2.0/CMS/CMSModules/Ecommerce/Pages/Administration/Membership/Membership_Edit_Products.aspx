...
<asp:Content ID="bodyContentElem" runat="server" ContentPlaceHolderID="plcContent">
    ...
    <cms:UniGrid ID="productsUniGridElem" runat="server" Columns="SKUName, SKUPrice, SKUValidity, SKUValidFor, SKUValidUntil, SKUSiteID, SKUMembershipGUID, SKUID, SKUOptionCategoryID" OrderBy="SKUName" OnOnExternalDataBound="productsUniGridElem_OnExternalDataBound" OnOnDataReload="productsUniGridElem_OnDataReload">
        <GridColumns>
            ...
            <ug:Column Name="Validity" Source="##ALL##" ExternalSourceName="skuvalidity" Caption="$product_list.productvalidity$"
                Wrap="false" />
            <ug:Column Name="IsProductOption" Source="##ALL##" ExternalSourceName="skuisproductoption" Caption="$ecommerce.isproductoption$" Wrap="false" />
            <ug:Column Name="ProductOptionCategoryName" Source="##ALL##" ExternalSourceName="skuproductoptioncategoryname" Caption="$ecommerce.productoptioncategory$" Wrap="false" />
