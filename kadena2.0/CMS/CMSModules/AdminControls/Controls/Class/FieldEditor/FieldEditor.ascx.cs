...
public partial class CMSModules_AdminControls_Controls_Class_FieldEditor_FieldEditor : BaseFieldEditor
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (string.Equals(DisplayIn, FormInfo.DISPLAY_CONTEXT_DASHBOARD, StringComparison.InvariantCultureIgnoreCase))
        {
    ...
    private void LoadDefaultAttributeEditForm(bool partialReload)
    {
        ...
        var defaultControl = FormHelper.GetFormFieldDefaultControlType(databaseConfiguration.AttributeType, GetControls(DisplayedControls, Mode, DevelopmentMode));
    ...
    private void LoadSelectedField(bool partialReload)
    {
        ...
        if (ffi != null)
        {
            ...
            if (!partialReload)
            {
                bool controlIsInvalid = !ffi.Visible || !string.Equals(ffi.Settings["controlname"] as String, FormHelper.GetFormFieldControlTypeString(FormFieldControlTypeEnum.Unknown), StringComparison.InvariantCultureIgnoreCase);
                chkDisplayInForm.Checked = ffi.Visible && controlIsInvalid;
                chkDisplayInDashBoard.Checked = string.Equals(ffi.DisplayIn, DisplayIn, StringComparison.InvariantCultureIgnoreCase);
            }
    ...
    protected void btnDeleteItem_Click(Object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            using (var tr = new CMSLateBoundTransaction())
            {
                ...
                {
                    EventLogProvider.LogException("FieldEditor", "DELETEOBJ", ex);
    ...
    private void databaseConfiguration_AttributeChanged(object sender, EventArgs e)
    {
        ...
        fieldAppearance.ClassName = ClassName;
        fieldAppearance.AttributeType = databaseConfiguration.AttributeType;
        fieldAppearance.FieldType = FormHelper.GetFormFieldDefaultControlType(databaseConfiguration.AttributeType, GetControls(DisplayedControls, Mode, DevelopmentMode));
        fieldAppearance.LoadFieldTypes(IsPrimaryField);
    ...
    private void LoadControlSettings(string selectedFieldType = null)
    {
        ...
        if (ffi != null)
        {
            ...
            bool selectionChanged = !selectedFieldType.Equals(ffi.Settings["controlname"] as String, StringComparison.InvariantCultureIgnoreCase);
            if (!selectionChanged)
            {
