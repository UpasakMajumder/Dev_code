    ...
    public class KenticoModelMappingsProfile : Profile
    {
        public KenticoModelMappingsProfile()
        {
            ...
            CreateMap<ShoppingCartItemInfo, CartItemEntity>()
                ...
                //.ForMember(dest => dest.CartItemCampaignID, opt => opt.MapFrom(src => src.GetIntegerValue("CartItemCampaignID", 0)))
                //..ForMember(dest => dest.CartItemDistributorID, opt => opt.MapFrom(src => src.GetIntegerValue("CartItemDistributorID", 0)))
                //.ForMember(dest => dest.CartItemProgramID, opt => opt.MapFrom(src => src.GetIntegerValue("CartItemProgramID", 0)))
                ...
                //.ForMember(dest => dest.DesignFilePath, opt => opt.MapFrom(src => src.GetValue("DesignFilePath", string.Empty)))
                //.ForMember(dest => dest.DesignFilePathObtained, opt => opt.MapFrom(src => src.GetBooleanValue("DesignFilePathObtained", false)))
            ...
            CreateMap<CartItemEntity, ShoppingCartItemInfo>()
                ...
                //.AfterMap((src, dest) => dest.SetValue("CartItemCampaignID", src.CartItemCampaignID))
                //.AfterMap((src, dest) => dest.SetValue("CartItemDistributorID", src.CartItemDistributorID))
                //.AfterMap((src, dest) => dest.SetValue("CartItemProgramID", src.CartItemProgramID))
                ...
                //.AfterMap((src, dest) => dest.SetValue("DesignFilePath", src.DesignFilePath))
                //.AfterMap((src, dest) => dest.SetValue("DesignFilePathObtained", src.DesignFilePathObtained))
