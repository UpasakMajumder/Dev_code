    ...
    public class KenticoModelMappingsProfile : Profile
    {
        public KenticoModelMappingsProfile()
        {
            ...
            CreateMap<User, UserInfo>()
                ...
                .ForMember(dest => dest.UserURLReferrer, opt => opt.Ignore())
            ...
            CreateMap<UserSettings, UserSettingsInfo>()
                ...
                .ForMember(dest => dest.UserSettingsUserGUID, opt => opt.Ignore())
                .ForMember(dest => dest.UserSettingsID, opt => opt.Ignore())
                .ForMember(dest => dest.UserCampaign, opt => opt.Ignore())
                .ForMember(dest => dest.UserWaitingForApproval, opt => opt.Ignore())
                .ForMember(dest => dest.UserLogActivities, opt => opt.Ignore())
                .ForMember(dest => dest.UserActivationDate, opt => opt.Ignore())
                .ForMember(dest => dest.UserSignature, opt => opt.Ignore())
                .ForMember(dest => dest.UserPicture, opt => opt.Ignore())
                .ForMember(dest => dest.UserAvatarID, opt => opt.Ignore())
                .ForMember(dest => dest.UserAvatarType, opt => opt.Ignore())
                .ForMember(dest => dest.UserNickName, opt => opt.Ignore())
                .ForMember(dest => dest.UserActivatedByUserID, opt => opt.Ignore())
                .ForMember(dest => dest.UserMessagingNotificationEmail, opt => opt.Ignore())
                .ForMember(dest => dest.UserTimeZoneID, opt => opt.Ignore())
                .ForMember(dest => dest.UserBadgeID, opt => opt.Ignore())
                .ForMember(dest => dest.UserShowIntroductionTile, opt => opt.Ignore())
                .ForMember(dest => dest.UserActivityPoints, opt => opt.Ignore())
                .ForMember(dest => dest.UserForumPosts, opt => opt.Ignore())
                .ForMember(dest => dest.UserBlogComments, opt => opt.Ignore())
                .ForMember(dest => dest.UserMessageBoardPosts, opt => opt.Ignore())
                .ForMember(dest => dest.UserGender, opt => opt.Ignore())
                .ForMember(dest => dest.UserDateOfBirth, opt => opt.Ignore())
                .ForMember(dest => dest.WindowsLiveID, opt => opt.Ignore())
                .ForMember(dest => dest.UserFacebookID, opt => opt.Ignore())
                .ForMember(dest => dest.UserLinkedInID, opt => opt.Ignore())
                .ForMember(dest => dest.UserPosition, opt => opt.Ignore())
                .ForMember(dest => dest.UserSkype, opt => opt.Ignore())
                .ForMember(dest => dest.UserPhone, opt => opt.Ignore())
                .ForMember(dest => dest.UserIM, opt => opt.Ignore())
                .ForMember(dest => dest.UserBlogPosts, opt => opt.Ignore())
                .ForMember(dest => dest.UserDescription, opt => opt.Ignore())
                .ForMember(dest => dest.UserUsedWebParts, opt => opt.Ignore())
                .ForMember(dest => dest.UserUsedWidgets, opt => opt.Ignore())
                .ForMember(dest => dest.UserPasswordRequestHash, opt => opt.Ignore())
                .ForMember(dest => dest.UserInvalidLogOnAttempts, opt => opt.Ignore())
                .ForMember(dest => dest.UserInvalidLogOnAttemptsHash, opt => opt.Ignore())
                .ForMember(dest => dest.UserPasswordLastChanged, opt => opt.Ignore())
                .ForMember(dest => dest.UserAccountLockReason, opt => opt.Ignore())
                .ForMember(dest => dest.UserDataComUser, opt => opt.Ignore())
                .ForMember(dest => dest.UserDataComPassword, opt => opt.Ignore())
                .ForMember(dest => dest.UserDashboardApplications, opt => opt.Ignore())
                .ForMember(dest => dest.UserDismissedSmartTips, opt => opt.Ignore())
                .ForMember(dest => dest.AllowPartialUpdate, opt => opt.Ignore())
                .ForMember(dest => dest.Properties, opt => opt.Ignore())
                .ForMember(dest => dest.ColumnNames, opt => opt.Ignore())
                .ForMember(dest => dest.TypeInfo, opt => opt.Ignore())
