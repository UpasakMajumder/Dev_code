...
export const ORDERS_REPORTS_GET_ROWS = 'ORDERS_REPORTS_GET_ROWS';
export const ORDERS_REPORTS_CHANGE_DATE = 'ORDERS_REPORTS_CHANGE_DATE';
export const ORDERS_REPORTS_MANAGE = 'ORDERS_REPORTS_MANAGE';
export const RECENT_ORDERS = 'RECENT_ORDERS';
export const RECENT_ORDERS_GET_ROWS = 'RECENT_ORDERS_GET_ROWS';
export const RECENT_ORDERS_CHANGE_PAGE = 'RECENT_ORDERS_CHANGE_PAGE';
export const RECENT_ORDERS_CHANGE_DATE = 'RECENT_ORDERS_CHANGE_DATE';
export const MODIFY_MAILING_LIST = 'MODIFY_MAILING_LIST';
export const CHANGE_SEARCH_QUERY = 'CHANGE_SEARCH_QUERY';
export const CHANGE_PAGE_PAGINATOR = 'CHANGE_PAGE_PAGINATOR';
export const THUMBNAIL_PREVIEW_TOGGLE = 'THUMBNAIL_PREVIEW_TOGGLE';
...
export const TAC_OPEN = 'TAC_OPEN';
export const TAC_CLOSE = 'TAC_CLOSE';
...
export const EMAIL_PROOF_TOGGLE = 'EMAIL_PROOF_TOGGLE';
